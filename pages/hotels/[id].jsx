...
//           alt="hotel" width={2000} height={2000} className="w-full h-large-box my-5 " />
//           <div className="">
//             <h3 className="text-3xl font-bold">
//                 jhgfkuygfuykgrjmerhbk,bf,erkgygeisghbjbvhfdgbvhjdgyukdgjhbdbvjh,gdhvbhdvdhgxv
//             </h3>
//             <p className="text-xl my-5 text-justify ">
//               jgvgjuvjfvgjvjdxgfxdkgfdjhbv dnbxdvhjxgvhdgvhfjnd bnvhmhfghhhhvbbvbcn vnbvhdgvhdxvbn vnbvfhmdgvfhbvxvhxghdvhbvnbvjhgb  
//             </p>
